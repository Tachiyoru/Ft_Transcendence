...
const AboutToPlay = () => {
	...
	// 	if (game)
	// 	{
	// 		const player1 = 'lol'; // Replace with your actual data
	// 		const player2 = 'lol' // Replace with your actual data
			...
			<div>
				...
				<div className="flex flex-row justify-center gap-14 mb-32">
					<div className='flex flex-col items-center'>
						...
						<p className='text-base mt-2'>2</p>
					</div>
					<div className='flex flex-col items-center'>
						...
						{/* } */}
						<p className='text-base mt-2'>1</p>
					</div>
				</div>
			</div>
			<p

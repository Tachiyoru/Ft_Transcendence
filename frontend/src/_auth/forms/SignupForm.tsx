		...
		<section className='container mx-auto px-5 py-10'>
			<div className='w-full max-w-sm mx-auto'>
				...
				<div className='mb-4 w-full'>
					...
					{passwordHasContent && (
					<ul>
						<li className="flex align-items text-xs mt-4" style={{ color: passwordHasLowercaseLetter ? 'green' : 'red' }}>
							<AiOutlineCheck className="mt-0.5 mr-2"/> 
							One lower letter
						</li>
						<li className="flex align-items text-xs" style={{color: passwordHasUppercaseLetter ? 'green' : 'red'}}>
							<AiOutlineCheck className="mt-0.5 mr-2"/> 
							One uppercase letter
						</li>
						<li className="flex align-items text-xs" style={{color: (passwordHasSpecialCharacter || passwordHasNumber) ? 'green' : 'red'}}>
							<AiOutlineCheck className="mt-0.5 mr-2"/> 
							One number or special character
						</li>
						<li className="flex align-items text-xs" style={{color: passwordHasValidLength ? 'green' : 'red'}}>
							<AiOutlineCheck className="mt-0.5 mr-2"/> 
				...
				<div className='mb-6 w-full'>
					...
					<ul>
						<li className="flex align-items text-xs mt-4" style={{ color: confirmPassword ? 'green' : 'red' }}>
							<AiOutlineCheck className="mt-0.5 mr-2"/> 
							Confirm password
						</li>
					</ul>
				...
				{/*Social Sign*/}
				<SocialIcons onGoogleClick={handleGoogleClick} on42Click={handle42Click} />

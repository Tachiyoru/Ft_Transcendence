  ...
  return (
    <MainLayout currentPage={currentPage}>
        <div className="flex-1 md:flex flex-row">
          ...
          {/*leftSideBar*/}
          <div className="md:rounded-l-lg bg-purple-950 p-4 px-4 text-gray-400 grid grid-rows-[auto,1fr,auto]">
          ...
          {/*Dashboard*/}
          <div className="flex-1 bg-purple-950 bg-opacity-80 p-4 md:rounded-r-lg">
